...
export default function Home() {
  return (
    <div className="space-y-16 text-app">
      <section className="card p-8 sm:p-12 soft-glow motion-fade-up motion-1">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          {[
            ...
            <div key={item.title} className="card p-4 hover-lift">
      ...
      <section className="space-y-6 motion-fade-up motion-2">
        <div className="flex items-center justify-between gap-4">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.28em] text-muted">Services</p>
            <h2 className="mt-2 text-2xl font-semibold">Core restoration specialties</h2>
          </div>
          <Link href="/Services" className="text-sm font-medium underline focus-ring text-muted hover:text-app">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <Link
              key={service.title}
              href={service.href}
              className="card p-5 transition hover-lift focus-ring"
            >
      ...
      <section className="card p-8 sm:p-10 motion-fade-up motion-3">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link href="/Process" className="text-sm font-medium underline focus-ring text-muted hover:text-app">
            See the full process →
          </Link>
        </div>
        <div className="mt-6 grid gap-3 sm:grid-cols-5">
          {["Inspect", "Decon", "Correct", "Protect", "Finish"].map((step) => (
            <div key={step} className="card px-4 py-3 text-center text-sm font-medium hover-lift">
              {step}
            </div>
          ))}
        </div>
      ...
      <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr] motion-fade-up motion-4">
        <div className="card p-8 sm:p-10">
          ...
          <Link href="/About" className="mt-5 inline-block text-sm font-medium underline focus-ring text-muted hover:text-app">
        ...
        <div className="card p-8 sm:p-10">
          ...
          <Link href="/Gallery" className="mt-5 inline-block text-sm font-medium underline focus-ring text-muted hover:text-app">
            View the gallery →
          </Link>
        </div>
      </section>

      <section className="cta-card p-8 sm:p-10 motion-fade-up motion-5">
